...
public interface Palettes {
    String[] FLAT_COLORS = {
            "#E64E42", "#BF3A31", "#E57F31", "#D25519", "#FFCC2F", "#FEA829",
            "#F0DEB7", "#D5C298", "#354A5D", "#2D3E50", "#2B2B2B", "#262626",
            "#9B5DB5", "#8D48AB", "#3C7080", "#376272", "#3B9AD9", "#2F81B8",
            "#39CB75", "#30AD63", "#2ABC9D", "#23A086", "#EDF1F2", "#BEC4C8",
            "#808C8D", "#365F42", "#2E5037", "#7561C3", "#5B4BA1", "#5E4536",
            "#503B2D", "#5D365D", "#4F2C4F", "#ED737D", "#D8565C", "#A6C646",
            "#8FAF30", "#F37FC3", "#D35F9E", "#78312C", "#652723", "#A38673",
            "#16A085", "#2ECC71", "#27AE60", "#3498DB", "#2980B9", "#9B59B6",
            "#8E44AD", "#34495E", "#2C3E50", "#F1C40F", "#F39C12", "#E67E22",
            "#D35400", "#E74C3C", "#C0392B", "#ECF0F1", "#BDC3C7", "#95A5A6",
            "#7F8C8D", "#6F532A", "#1abc9c", "#ea4c88", "#8D7260", "#B9CAF0",
            "#9AABD2", "#5167A0", "#3A4E7F"
    };
    ...
    String[] MATERIAL_COLORS = {
            ...
            "#E1F5FE", "#B3E5FC", "#81D4fA", "#4fC3F7", "#29B6FC", "#03A9F4",
            ...
            "#E6EE9C", "#DCE775", "#D4E157", "#CDDC39", "#C0CA33", "#A4B42B",
            "#9E9D24", "#827717", "#F4FF81", "#EEFF41", "#C6FF00", "#AEEA00",
            "#FFFDE7", "#FFF9C4", "#FFF590", "#FFF176", "#FFEE58", "#FFEB3B",
            "#FDD835", "#FBC02D", "#F9A825", "#F57F17", "#FFFF82", "#FFFF00",
            ...
            "#FBE9A7", "#FFCCBC", "#FFAB91", "#FF8A65", "#FF7043", "#FF5722",
            "#F4511E", "#E64A19", "#D84315", "#BF360C", "#FF9E80", "#FF6E40",
            "#FF3D00", "#DD2600", "#EFEBE9", "#D7CCC8", "#BCAAA4", "#A1887F",
            "#8D6E63", "#795548", "#6D4C41", "#5D4037", "#4E342E", "#3E2723",
            "#FAFAFA", "#F5F5F5", "#EEEEEE", "#E0E0E0", "#BDBDBD", "#9E9E9E",
            "#757575", "#616161", "#424242", "#212121", "#000000", "#ffffff",
            "#ECEFF1", "#CFD8DC", "#B0BBC5", "#90A4AE", "#78909C", "#607D8B",
